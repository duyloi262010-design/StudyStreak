...
const Dashboard: React.FC<Props> = ({ profile, onStartQuiz, onOpenChat, onEditSchedule }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-6 space-y-6 md:space-y-10 animate-fadeIn font-sans">
             ...
             <div className="relative z-10">
               ...
               <div className="flex flex-wrap gap-2 md:gap-3">
                 {studySubjects.length > 0 ? studySubjects.map(s => (
                   <span key={s} className="font-display px-4 py-2 md:px-6 md:py-3 bg-white/15 backdrop-blur-xl rounded-xl md:rounded-2xl text-sm md:text-lg font-black border border-white/20">
                     {s}
                   </span>
