            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-black text-slate-800 dark:text-white uppercase tracking-tighter">
                  {step === 1 ? 'Thông tin cá nhân' : step === 2 ? t.onboardingTitle : step === 3 ? t.stepTextbook : 'Mục tiêu hàng ngày'}
                </h1>
                <p className="text-xs font-bold text-slate-400 dark:text-slate-500">
                    {step === 1 ? 'Hãy để tớ biết bạn là ai' : step === 2 ? t.onboardingDesc : step === 3 ? 'Chọn tài liệu học tập phù hợp' : 'Thiết lập chỉ tiêu để nhận thưởng'}
                </p>
              </div>
            </div>
          ...
          {step === 4 && (
            <div className="space-y-12 py-10 animate-fadeIn text-center">
                <div className="space-y-4">
                    ...
                    <h2 className="text-3xl font-black text-slate-800 dark:text-white uppercase tracking-tighter">Bạn muốn học bao nhiêu giờ mỗi ngày?</h2>
                    <p className="text-slate-500 font-bold">Vượt qua chỉ tiêu này sẽ giúp {petName} nhận thêm +1 EXP!</p>
                </div>
                
                <div className="max-w-md mx-auto space-y-8 bg-slate-50 dark:bg-slate-800/50 p-10 rounded-[3rem] border-2 border-slate-100 dark:border-slate-800 shadow-inner">
                    <div className="text-6xl font-black text-purple-600">{dailyGoalHours} <span className="text-2xl opacity-60">giờ</span></div>
                    <input 
                        type="range" 
                        min="1" 
                        max="12" 
                        ...
                        className="w-full h-4 bg-slate-200 dark:bg-slate-700 rounded-lg appearance-none cursor-pointer accent-purple-600 shadow-sm"
                    />
                ...
                <div className="bg-purple-100 dark:bg-purple-900/20 p-4 rounded-2xl inline-block border border-purple-200 dark:border-purple-800">
                    <p className="text-xs font-black text-purple-700 dark:text-purple-400 uppercase tracking-widest">✨ Bạn có thể thay đổi mục tiêu này bất cứ lúc nào trong cài đặt!</p>
                </div>
            </div>
          )}
